...
external_url 'https://gitlab.wisecoding.io'
registry_external_url 'https://registry.wisecoding.io'
pages_external_url 'http://pages.pages.wisecoding.io'
...
gitlab_rails['db_password'] = 'gitlab@dm1n'
...
gitlab_rails['initial_root_password'] = 'root@dm1n'
...
gitlab_rails['smtp_address'] = "zoho.mail.com"
gitlab_rails['smtp_port'] = 489
gitlab_rails['smtp_user_name'] = "gitlab@wisecoding.net"
gitlab_rails['smtp_password'] = "smtp@pwd"
